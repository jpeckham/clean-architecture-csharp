...
public sealed record LoginHttpRequest(string Handle, string Password);
public sealed record LoginWithDeviceHttpRequest(string Handle, string Password, string DeviceId);
